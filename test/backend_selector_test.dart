...
void main() {
  test('selects Firebase repository only when Firebase is ready and user exists', () {
  ...
  test('falls back to fake repository until Firebase has an authenticated user', () {
    final fake = _StubRepository();
